...
using namespace std;
    ...
    bool helper(vector<vector<int>>& grid, int r, int c, int n, int expVal){
        ...
        expVal++;
        bool ans1 = helper(grid, r-2, c-1, n, expVal);
        bool ans2 = helper(grid, r-2, c+1, n, expVal);
        bool ans3 = helper(grid, r-1, c-2, n, expVal);
        bool ans4 = helper(grid, r-1, c+2, n, expVal);
        bool ans5 = helper(grid, r+1, c-2, n, expVal);
        bool ans6 = helper(grid, r+1, c+2, n, expVal);
        bool ans7 = helper(grid, r+2, c-1, n, expVal);
        bool ans8 = helper(grid, r+2, c+1, n, expVal);
    ...
    int main(){
        vector<vector<int>> grid = {{0, 11, 16, 5, 20},
                        ...
                        {24, 13, 2, 7, 22}};
        cout<<boolalpha;
        cout<<"Knight Tour Is Possible : "<<checkValidGrid(grid)<<endl;
        return 0;
    }
